...
anchors = ["b__R_Toe__","b__L_Toe__","b__R_Foot__","b__L_Foot__","b__R_Calf__","b__L_Calf__","b__R_Elbow__","b__L_Elbow__"]

kneeBones = ["b__L_Calf__","b__R_Calf__"]
hipBones = ["b__L_Thigh__","b__R_Thigh__"]
elbowBones = ["b__L_Forearm__","b__R_Forearm__"]
shoulderBones = ["b__L_UpperArm__","b__R_UpperArm__"]
